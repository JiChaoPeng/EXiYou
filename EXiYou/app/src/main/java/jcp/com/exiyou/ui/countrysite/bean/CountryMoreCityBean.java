...
public class CountryMoreCityBean {
    private List<CountryMoreCityModelBean> data;

    public List<CountryMoreCityModelBean> getData() {
        return data;
    }

    public void setData(List<CountryMoreCityModelBean> data) {
        this.data = data;
    }
}
