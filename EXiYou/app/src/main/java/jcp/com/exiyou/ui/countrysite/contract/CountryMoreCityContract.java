package jcp.com.exiyou.ui.countrysite.contract;
...
import jcp.com.exiyou.ui.countrysite.activity.CountryMoreCityActivity;
...
public interface CountryMoreCityContract {
    public abstract class CountryMoreCityPersenter extends BasePresenter<CountryMoreCityModel,CountryMoreCityView>{
        public abstract void getCountryMoreCityPage(CountryMoreCityActivity.State state, int page, int country_id);
    }
    interface CountryMoreCityModel extends BaseModel{
        Observable<CountryMoreCityBean> getCountryCity(CountryMoreCityActivity.State state,int page,int country_id);
    }
    interface CountryMoreCityView extends BaseView{
        void returnCity(CountryMoreCityActivity.State state,CountryMoreCityBean moreCityBean);
    }
}
