package jcp.com.exiyou.ui.destination.presenter;
...
public class DestinationPresenter extends DestinationContract.DestinationPresenter{
    ...
    public void getMovieList() {
        ...
        mModel.getListBean().subscribe(new Subscriber<DestinationListBean>() {
            @Override
            ...
            @Override
            public void onNext(DestinationListBean listBean) {
                Log.e(TAG, "onNext: "+listBean.getData() );
                mView.retrunList(listBean);
            }
        });
    }
}
