package jcp.com.exiyou.ui.homepage.bean;
...
public class HomePageDataBean {
    ...
    private List<HomePageSlideBean> slide;
    private HomePageFeedBean feed;
    private HomePageCommentEntryBean comment_entry;
    ...
    public List<HomePageSlideBean> getSlide() {
        return slide;
    }

    public void setSlide(List<HomePageSlideBean> slide) {
        this.slide = slide;
    }

    public HomePageFeedBean getFeed() {
        return feed;
    }

    public void setFeed(HomePageFeedBean feed) {
        this.feed = feed;
    }

    public HomePageCommentEntryBean getComment_entry() {
        return comment_entry;
    }

    public void setComment_entry(HomePageCommentEntryBean comment_entry) {
