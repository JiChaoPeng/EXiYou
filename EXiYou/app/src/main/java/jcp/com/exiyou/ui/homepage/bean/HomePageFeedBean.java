...
public class HomePageFeedBean {
    private int total;
    private int page;
    private List<HomePageEntryBean> entry;
    ...
    public List<HomePageEntryBean> getEntry() {
        return entry;
    }

    public void setEntry(List<HomePageEntryBean> entry) {
        this.entry = entry;
    }
}
