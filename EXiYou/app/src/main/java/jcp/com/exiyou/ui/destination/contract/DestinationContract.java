package jcp.com.exiyou.ui.destination.contract;
...
public interface DestinationContract {
    public abstract class DestinationPresenter extends BasePresenter<DestinationModel,DestinationView> {
        public abstract void getMovieList();

    }
    interface DestinationModel extends BaseModel{
        Observable<DestinationListBean> getListBean();
    }
    public interface DestinationView extends BaseView{
        void retrunList(DestinationListBean listBean);
    }
}
