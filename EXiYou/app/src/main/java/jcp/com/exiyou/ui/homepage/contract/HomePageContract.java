package jcp.com.exiyou.ui.homepage.contract;
...
public interface HomePageContract {
    public abstract class HomePagePersenter extends BasePresenter<HomePageModel,HomePageView>{
        public abstract void getHomePageBean(HomePageFragment.State state, int page);
        public abstract void getViewPager( int wight,int hight,Context context,HomePageBean homePageBean);
    }
    interface HomePageModel extends BaseModel{
        Observable<HomePageBean> getListBean(HomePageFragment.State state, int page);
        List<ImageView> getViewPager( int wight,int hight,Context context,HomePageBean homePageBean);

    }
    interface HomePageView extends BaseView{
        void retrunList(HomePageFragment.State state, HomePageBean homePageBean);
        void returnViewPager(List<ImageView> list);
    }
}
