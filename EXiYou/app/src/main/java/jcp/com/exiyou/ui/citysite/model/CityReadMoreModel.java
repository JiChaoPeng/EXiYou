...
public class CityReadMoreModel implements CityReadMoreContract.CityReadMoreModel {
    @Override
    public Observable<CityReadMoreBean> getListBean(CityReadMoreActivity.State state, String id,int page) {
        return Api.getHostService().getMoreCityRes(id,page).compose(new
                AndroidIOToMain.IOToMainTransformer<CityReadMoreBean>());
    }
}
