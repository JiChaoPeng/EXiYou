...
public class CounrtryViewPagerAdapter extends PagerAdapter{
    private static final String TAG = CounrtryViewPagerAdapter.class.getSimpleName();
    private List<ImageView> data;
    private Context context;
    public CounrtryViewPagerAdapter(Context context, List<ImageView> data) {
