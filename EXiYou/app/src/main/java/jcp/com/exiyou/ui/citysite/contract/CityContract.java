...
public interface CityContract {
    public abstract class CityPersenter extends BasePresenter<CityModel,CityView> {
        public abstract void CityBean(String city_id);
        public abstract void CityPager(int wight, int hight, Context context, CitySiteBean citySiteBean);

    }
    interface CityModel extends BaseModel {
        Observable<CitySiteBean> CityBean(String city_id);
        List<ImageView> CityPager(int wight, int hight, Context context, CitySiteBean citySiteBean);
    }
    interface CityView extends BaseView {
        void retrunList(CitySiteBean citySiteBean);
