package jcp.com.exiyou.ui.countrysite.adapters;
...
import jcp.com.exiyou.ui.countrysite.bean.CountryMoreCityModelBean;
...
public class CountryMoreCityAdapter extends BaseListViewAdapter<CountryMoreCityModelBean>{
    private Context context;
    public CountryMoreCityAdapter(Context context, String mType, List<CountryMoreCityModelBean> mData, int... layoutIds) {
        super(context, mType, mData, layoutIds);
        this.context=context;
    }

    @Override
    protected void loadData(ViewHolder holder, CountryMoreCityModelBean item, int position) {
        holder.setText(R.id.country_more_item_cname,item.getCatename());
        holder.setText(R.id.country_more_item_ename,item.getCatename_en());
        holder.setText(R.id.country_more_item_context,item.getRepresentative());
        holder.setText(R.id.country_more_item_people,item.getBeenstr());
        holder.setImage(context,R.id.country_more_item_image,item.getPhoto());
    }
}
