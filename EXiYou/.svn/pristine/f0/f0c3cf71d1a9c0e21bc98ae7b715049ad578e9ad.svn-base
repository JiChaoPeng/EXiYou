package jcp.com.exiyou.ui.destination.model;
...
public class DestinationModel implements DestinationContract.DestinationModel {

    @Override
    public Observable<DestinationListBean> getListBean() {
        return Api.getHostService().getDestinationRes()
