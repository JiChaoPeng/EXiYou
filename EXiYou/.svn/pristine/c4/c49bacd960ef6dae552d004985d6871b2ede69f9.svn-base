...
public interface ApiService {
    ...
    @GET(HttpParams.SHOP_SEARCH)
    Observable<ShopSearchListBean> getShopSearchRes2(@Query("type1")String type,@Query("page")String page,@Query("city_id")String city_id);

    @GET(HttpParams.SHOP_SEARCH)
    Observable<ShopSearchListBean> getShopSearchRes3(@Query("type1")String type,@Query("page")String page,@Query("city_id")String city_id,@Query("order")int order);

    @GET(HttpParams.SHOP_SEARCH)
    Observable<ShopSearchListBean> getShopSearchRes4(@Query("type1")String type,@Query("page")String page,@Query("order")int order);
    ...
    @GET(HttpParams.City_Read_More)
    Observable<CityReadMoreBean> getMoreCityRes(@Query("id") String id, @Query("page") int page);
