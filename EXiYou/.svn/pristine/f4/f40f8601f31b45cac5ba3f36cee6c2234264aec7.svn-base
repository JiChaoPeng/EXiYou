...
public class CountryTicketAdapter extends BaseListViewAdapter<CountrySiteIconList> {
    private Context context;
    public CountryTicketAdapter(Context context, String mType, List<CountrySiteIconList> mData, int... layoutIds) {
        super(context, mType, mData, layoutIds);
        this.context=context;
    }

    @Override
    protected void loadData(ViewHolder holder, CountrySiteIconList item, int position) {
        holder.setImage(context, R.id.country_ticket_image,item.getIcon_pic());
        holder.setText(R.id.country_ticket_text,item.getIcon());
    }
}
