...
import jcp.com.exiyou.ui.countrysite.bean.CountrySiteIconList;
...
public class CountryHotCityAdapter extends BaseListViewAdapter<CountrySiteHotCity> {
    private Context context;
    public CountryHotCityAdapter(Context context, String mType, List<CountrySiteHotCity> mData, int... layoutIds) {
        super(context, mType, mData, layoutIds);
        this.context=context;
    }

    @Override
    protected void loadData(ViewHolder holder, CountrySiteHotCity item, int position) {
        holder.setImage(context, R.id.country_hot_city_image,item.getPhoto());
        holder.setText(R.id.country_hot_city_text,item.getCnname());
        holder.setText(R.id.country_hot_city_subtext,item.getEnname());
    }
}
