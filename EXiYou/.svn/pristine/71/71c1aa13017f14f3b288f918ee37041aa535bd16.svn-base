...
public class CityTicketAdapter extends BaseListViewAdapter<CitySiteBean.DataBean.IconListBean> {
    private Context context;

    public CityTicketAdapter(Context context, String mType, List<CitySiteBean.DataBean.IconListBean> mData, int... layoutIds) {
        super(context, mType, mData, layoutIds);
        this.context = context;
    }

    @Override
    protected void loadData(ViewHolder holder, CitySiteBean.DataBean.IconListBean item, int position) {
