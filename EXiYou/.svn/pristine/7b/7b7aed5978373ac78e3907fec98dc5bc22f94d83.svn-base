package jcp.com.exiyou.ui.citysite.adapters;
...
public class CityReadMoreListAdapter extends BaseListViewAdapter<CityReadMoreBean.DataBean.PoisBean> {
    private Context context;
    public CityReadMoreListAdapter(Context context, String mType, List<CityReadMoreBean.DataBean.PoisBean> mData, int... layoutIds) {
        super(context, mType, mData, layoutIds);
        this.context=context;
    }

    @Override
    protected void loadData(ViewHolder holder, CityReadMoreBean.DataBean.PoisBean item, int position) {
        holder.setImage(context, R.id.city_read_more_item_list_image,item.getPhoto());
        holder.setText(R.id.city_read_more_item_list_name,item.getFirstname());
        holder.setText(R.id.city_read_more_item_list_content,item.getDescription());
        holder.setText(R.id.city_read_more_item_list_people,item.getBeenstr());
    }
}
