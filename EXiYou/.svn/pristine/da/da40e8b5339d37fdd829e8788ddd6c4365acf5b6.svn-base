package jcp.com.exiyou.ui.destination.bean;
...
public class DestinationCityListBean {
    private List<DestinationCityBean> citylist;
    private List<DestinationCountyBean> countrylist;
    ...
    public List<DestinationCountyBean> getCountrylist() {
        return countrylist;
    }

    public void setCountrylist(List<DestinationCountyBean> countrylist) {
        this.countrylist = countrylist;
    }

    public List<DestinationCityBean> getCitylist() {
        return citylist;
    }

    public void setCitylist(List<DestinationCityBean> citylist) {
