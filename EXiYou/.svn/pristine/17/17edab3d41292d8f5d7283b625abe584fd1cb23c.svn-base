package jcp.com.exiyou.ui.citysite.contract;
...
import jcp.com.exiyou.ui.citysite.activity.CityReadMoreActivity;
...
public interface CityReadMoreContract {
    public abstract class CityReadMorePersenter extends BasePresenter<CityReadMoreModel,CityReadMoreView> {
        public abstract void CityReadMorePageBean(CityReadMoreActivity.State state, String id,int page);
    }
    interface CityReadMoreModel extends BaseModel {
        Observable<CityReadMoreBean> getListBean(CityReadMoreActivity.State state,String id, int page);

    }
    interface CityReadMoreView extends BaseView {
        void retrunList(CityReadMoreActivity.State state, CityReadMoreBean homePageBean);
    }
}
