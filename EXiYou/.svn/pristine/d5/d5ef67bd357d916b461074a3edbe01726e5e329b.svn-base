...
public class CountryMoreCityActivity extends BaseActivity<CountryMoreCityPresenter, CountryMoreCityModel> implements CountryMoreCityContract.CountryMoreCityView, SwipeRefreshLayout.OnRefreshListener, AbsListView.OnScrollListener, AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.country_more_city_back:
                finish();
                break;
        }
    }
