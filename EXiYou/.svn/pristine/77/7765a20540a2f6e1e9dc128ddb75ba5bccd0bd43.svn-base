...
public class ImageUtil {
     ...
     * 压缩图片
     **/
//    public static Bitmap sample2Image(Context context, int layoutId, int width, int hight) {
//        BitmapFactory.Options options = new BitmapFactory.Options();
//        options.inJustDecodeBounds = true;
////        int outHight = options.outHeight;
////        int outWidth = options.outWidth;
////        int max = Math.max(outHight / hight, outWidth / width);
//        options.inSampleSize = 2;
//        options.inJustDecodeBounds = false;
//        Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), layoutId, options);
//        return bitmap;
//    }

    public static Bitmap sample2Image(Context context, int layoutId, int size) {
        BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
//        int outHight = options.outHeight;
//        int outWidth = options.outWidth;
//        int max = Math.max(outHight / hight, outWidth / width);
    ...
    public static Bitmap sample2Image(Context context, int layoutId) {
        return sample2Image(context, layoutId, 2);
    }
}
