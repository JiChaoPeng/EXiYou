...
public interface CountryContract {
    public abstract class CountryPersenter extends BasePresenter<CountryModel,CountryView> {
        public abstract void CountryBean(int country_id);
        public abstract void CountryPager(int wight, int hight, Context context, CountrySiteBean countrySiteBean);

    }
    interface CountryModel extends BaseModel {
        Observable<CountrySiteBean> CountryBean(int country_id);
        List<ImageView> CountryPager(int wight, int hight, Context context, CountrySiteBean countrySiteBean);
    }
    interface CountryView extends BaseView {
        void retrunList(CountrySiteBean countrySiteBean);
