package jcp.com.exiyou.ui.countrysite.view;
...
public class CountryGridView extends GridView {
    public CountryGridView(Context context) {
        this(context,null);
    }
    ...
    public CountryGridView(Context context, AttributeSet attrs, int defStyleAttr) {
